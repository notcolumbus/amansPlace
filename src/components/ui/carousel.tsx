...
function CarouselPrevious({
  ...
  return (
    <button
      ...
      className={cn(
        "absolute text-6xl font-bold opacity-60 hover:opacity-100 transition-opacity disabled:opacity-20 disabled:cursor-not-allowed bg-black/10 rounded-full w-16 h-16 flex items-center justify-center hover:bg-black/20",
        orientation === "horizontal"
