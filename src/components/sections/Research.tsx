        ...
        <div className="flex flex-col md:flex-row w-full gap-2 atkinson-hyperlegible-next-regular">
            <div className="relative overflow-hidden aspect-[3/4] sm:aspect-auto sm:h-64 md:h-72 lg:h-96 w-full md:flex-1" style={{backgroundColor:"#2D2D2D"}} >
                ...
                <div className="absolute bottom-0 left-0 p-6 z-20 w-full">
                    ...
                    <p className="text-white text-base mt-2 atkinson-hyperlegible-next-regular drop-shadow-md">A regional-scale modeling framework to evaluate how hybrid-electric STOL aircraft can close rural mobility gaps through Regional Air Mobility.</p>
                </div>
            </div>
            <div className="relative overflow-hidden aspect-[3/4] sm:aspect-auto sm:h-64 md:h-72 lg:h-96 w-full md:flex-1" style={{backgroundColor:"#2D2D2D"}}>
                <video
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent z-10" />
                <div className="absolute p-6 left-0 top-0 z-20 w-full">
                    <h2 className="text-4xl text-white drop-shadow-lg atkinson-hyperlegible-next-regular ">Loopy Audio</h2>
                </div>
                <div className="absolute bottom-0 left-0 p-6 z-20 w-full">
                    <h1 className="text-xl text-white font-bold atkinson-hyperlegible-next-regular drop-shadow-lg">Automation Of Generation Of Spatial Audio</h1>
                    <p className="text-white text-base mt-2 atkinson-hyperlegible-next-regular drop-shadow-md">A new framework that automates music spatialization using contextual and structural cues embedded within a song's envelopes.</p>
                </div>
            </div>
        </div>
    )
