...
function Research() {
    return (
        <div className="flex w-full gap-2">
            <div className="relative overflow-hidden h-[600px] flex-1"style={{backgroundColor:"#2D2D2D"}} >
                <img
                ...
                <div className="absolute p-6 left-0 z-20">
                    <h2 className="text-5xl text-white  drop-shadow-lg">NASA RAM</h2>
                </div>
            ...
            <div className="relative overflow-hidden h-[600px] flex-1" style={{backgroundColor:"#2D2D2D"}}>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent z-10" />
                <div className="absolute p-6 left-0 z-20">
                    <h2 className="text-5xl text-white  drop-shadow-lg">Loopy Audio</h2>
                </div>
                <div className="absolute bottom-0 left-0 p-6 z-20 pt-20">
